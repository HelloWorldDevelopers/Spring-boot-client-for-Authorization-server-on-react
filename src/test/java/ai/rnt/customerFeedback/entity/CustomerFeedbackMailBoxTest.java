...
class CustomerFeedbackMailBoxTest {

	@Test
	void test() {
		CustomerFeedbackMailBox moduleMailBox = new CustomerFeedbackMailBox();
		...
		CustomerFeedbackMaster customerFeedback = new CustomerFeedbackMaster();
		moduleMailBox.setCustomerFeedbackMaster(customerFeedback);
