...
class EmployeePerformenceMailBoxTest {

	@Test
	void test() {
		EmployeePerformenceMailBox moduleMailBox = new EmployeePerformenceMailBox();
		...
		EmployeePerformenceMaster customerFeedback = new EmployeePerformenceMaster();
		moduleMailBox.setEmployeePerformenceMaster(customerFeedback);
